<div class="modal modal-center" id="aboutdialog" tabindex="-1" role="dialog" aria-labelledby="aboutdialog-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="aboutdialog-label">О проекте</h4>
            </div>
