...
class ReportsController extends Controller
{
    ...
    public function getSoftwaresList(Request $request) 
    {
        try {
            ...
            //     ));
            $data = DB::select( DB::raw("SELECT c.name AS name, t.version, t.vendor, t.install_date, t.identifying_number FROM tmp_softwares AS t JOIN computers AS c ON (tmp_softwares.computer_id = computers.id)" ));
